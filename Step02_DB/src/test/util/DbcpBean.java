 ...
 * <Resource name="jdbc/myoracle" auth="Container"
   ...
   <resource-ref>
	...
	- Dao 에서 Connection 객체를 사용한 후 .close() 메소드를 호출하면 자동으로 Connection Pool 에 Connection 객체가 반환된다.
 */
...
/*
 * 어디선가 커넥션 객체가 필요하다면 new DbcpBean().getConn(); 을 호출해서 사용한다.
 * 이런 코드가 필요한 곳은 DAO.
 * 커넥션은 우리가 만든 것이 아니기 때문에 하라는 대로 설정을 해야하고, 
 * 효율적으로 작성을 해야한다.
 */