...
public class CafeDao {
	...
	//인자로 전달되는 글내용을 수정 반영하는 메소드 (update.jsp)
	...
	//인자로 전달되는 글 번호를 이용해서 삭제하는 메소드 (datail.jsp, delete.jsp)
	...
	//글번호를 가져와서 글 조회수를 올리는 메소드 (detail.jsp)
	...
	//인자로 전달되는 글번호에 해당하는 글정보를 리턴하는 메소드 (detail.jsp)
