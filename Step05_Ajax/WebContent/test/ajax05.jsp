	...
	<script>
		document.querySelector("#sendBtn").addEventListener("click", function(){
			...
			*/
			...
			//자바스크립트는 직접 이렇게 만들어줘야한다. (이걸 편하게 하기 위해서 util을 사용.)
			fetch("add.jsp", {
				method:"POST",
				headers:{"Content-Type":"application/x-www-form-urlencoded; charset=utf-8"},
				body:queryString //요청 파라미터는 body에 달고 간다.
			})//{}안에 옵션 전달
...
<!-- 
encodeURIComponent 
encodeURIComponent("abcd1234가") => "abcd1234%EA%B0%80"
이렇게 변환됨.
특수 기호를 인코딩해서 보내줌. 
저렇게 안하면 &외 몇몇의 특수기호가 안보내짐.
