...
<%
	...
	//응답하고 나서 페이지 이동을 해도 읽어낼 수 있도록 HttpSession 객체에 저장을 한다. session 기본 객체.
...
.getAttribute() 메소드를 사용하는 실수들을 많이 하니 주의하기!
getAttribute() 는 setAttribute()를 읽어낼 때 사용. 용도가 서로 다름.
